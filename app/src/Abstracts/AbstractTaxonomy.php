...
abstract class AbstractTaxonomy
{
    ...
    public function __construct()
    {
        ...
        //        Container::make('term_meta', __('Advanced', 'mooms'))
        //                 ->where('term_taxonomy', '=', $this->taxonomy)
        //                 ->add_fields([
        //                                  Field::make('checkbox', 'show_homepage', __('Hiển thị ngoài trang chủ', 'mooms')),
        //                                  Field::make('text', 'thu_tu', __('Thứ tự', 'mooms'))->set_attribute('type', 'number'),
        //                              ]);
    }
    ...
    public function getLabels()
    {
        return [
            ...
            'all_items'         => __('Tất cả', 'mooms'),
            'edit_item'         => __('Chỉnh sửa', 'mooms'),
            'view_item'         => __('Xem', 'mooms'),
            'update_item'       => __('Cập nhật', 'mooms'),
            'add_new_item'      => __('Thêm mới', 'mooms'),
            'new_item_name'     => __('Tên mục mới', 'mooms'),
            'parent_item'       => __('Mục cha', 'mooms'),
            'parent_item_colon' => __('Mục cha:', 'mooms'),
            'search_items'      => __('Tìm kiếm', 'mooms'),
            'popular_items'     => __('Phổ biến', 'mooms'),
            'most_used'         => __('Thường dùng', 'mooms'),
            'not_found'         => __('Không có dữ liệu', 'mooms'),
        ];
    }
...
<?php get_footer() ?>');
    ...
    {
        // Container::make('post_meta', __('Cài đặt chung', 'mooms'))
        ...
        //          ->add_fields([
        //              Field::make('checkbox', 'noi_bat', __('Đánh dấu nổi bật', 'mooms')),
        //              Field::make('text', 'so_luot_xem', __('Số lượt xem', 'mooms'))->set_attribute('type', 'number'),
        //          ]);
    }
}
