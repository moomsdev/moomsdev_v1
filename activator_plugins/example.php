 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme RequiredPlugin
...
function mt_register_required_plugins() {
	...
	$config = array(
		...
		/*
		'strings'      => array(
			'page_title'                      => __( 'Install Required Plugins', 'mooms' ),
			'menu_title'                      => __( 'Install Plugins', 'mooms' ),
			/* translators: %s: plugin name. * /
			'installing'                      => __( 'Installing Plugin: %s', 'mooms' ),
			/* translators: %s: plugin name. * /
			'updating'                        => __( 'Updating Plugin: %s', 'mooms' ),
			'oops'                            => __( 'Something went wrong with the plugin API.', 'mooms' ),
